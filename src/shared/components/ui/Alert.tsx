...
const Alert = forwardRef<HTMLDivElement, AlertProps>(
  (
    ...
    const variants = {
      info: {
        container:
          "bg-blue-500/5 shadow-[inset_0_0_0_1px_theme(colors.blue.500/0.2)] text-blue-400",
        icon: <Info className="w-5 h-5" />,
        iconColor: "text-blue-400",
      },
      success: {
        container:
          "bg-lime-400/5 shadow-[inset_0_0_0_1px_theme(colors.lime.400/0.2)] text-lime-400",
        icon: <CheckCircle className="w-5 h-5" />,
        iconColor: "text-lime-400",
      },
      warning: {
        container:
          "bg-yellow-500/5 shadow-[inset_0_0_0_1px_theme(colors.yellow.500/0.2)] text-yellow-400",
        icon: <AlertCircle className="w-5 h-5" />,
        iconColor: "text-yellow-400",
      },
      error: {
        container:
          "bg-red-500/5 shadow-[inset_0_0_0_1px_theme(colors.red.500/0.2)] text-red-400",
