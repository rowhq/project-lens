  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={cn(
          "p-2 rounded-lg transition-colors text-[var(--muted-foreground)]",
          "hover:bg-[var(--secondary)] disabled:opacity-50 disabled:cursor-not-allowed"
        )}
...
export function PaginationInfo({
  ...
  return (
    <p className={cn("text-sm text-[var(--muted-foreground)]", className)}>
      Showing <span className="font-medium text-[var(--foreground)]">{start}</span> to{" "}
