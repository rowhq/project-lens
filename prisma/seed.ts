...
async function main() {
  ...
  // INVESTMENT INSIGHTS
  // ============================================
  console.log("📊 Seeding investment insights...");
  ...
  console.log(`✅ Created ${insights.length} investment insights`);

  // ============================================
  // PROPERTY OWNERS
  // ============================================
  console.log("🏠 Seeding property owners...");
  ...
  console.log(`✅ Created ${propertyOwners.length} property owners`);

  // ============================================
  // ENGINEER DIRECTORY
  // ============================================
  console.log("🔧 Seeding engineer directory...");
  ...
  // ============================================
  console.log("🛒 Seeding DD Marketplace listings...");
  ...
  console.log(
    `  ✅ Created ${marketplaceListings.length} marketplace listings`,
  );
